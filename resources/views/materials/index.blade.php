...
<body>
    ...
    <div class="container py-4" style="max-width: 600px;">
        <h4 class="mb-4 fw-bold">Kelola Data Material</h4>
        ...
        <div class="section-card">
            <h6 class="fw-bold mb-3"><i class="fas fa-list me-2"></i>Daftar Material</h6>
            @forelse($materials as $div)
                <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                    <span>{{ $div->name }}</span>
                    <form action="/materials/{{ $div->id }}" method="POST" onsubmit="return confirm('Hapus data material ini?')">
                        @csrf
                        @method('DELETE')
