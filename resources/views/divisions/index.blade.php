...
<body>
    ...
    <div class="container py-4" style="max-width: 600px;">
        <h4 class="mb-4 fw-bold">Kelola Divisi</h4>
        ...
        <div class="section-card mb-4">
            <h6 class="fw-bold text-primary mb-3"><i class="fas fa-plus-circle me-2"></i>Tambah Divisi Baru</h6>
        ...
        <div class="section-card">
            <h6 class="fw-bold mb-3"><i class="fas fa-list me-2"></i>Daftar Divisi</h6>
            @forelse($divisions as $div)
                <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                    <span>{{ $div->name }}</span>
                    <form action="/divisions/{{ $div->id }}" method="POST" onsubmit="return confirm('Hapus divisi ini?')">
                        @csrf
                        @method('DELETE')
            ...
            @empty
                <p class="text-muted fst-italic">Belum ada divisi.</p>
            @endforelse
        </div>
    </div>
</body>
